...
<div class="text-right">
  <a href="<?php echo e(route('post.show_applicant',['id'=>$posts->id])); ?>"><button class="btn btn-success">複写新規</button></a>
</div>
...
<div id="table-block">
    ...
    <form  method="get" action="<?php echo e(route('post.edit',['id'=>$posts->id])); ?>">
    <?php echo csrf_field(); ?>
        <div class="btn-area">
            <button type="submit" class="btn btn-primary add" style="margin: 100px">承認画面へ</button>
        </div>
    </form>  
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel_web_application/resources/views/posts/show.blade.php ENDPATH**/ ?>