...
<form  method="post" action="<?php echo e(route('post.store')); ?>">
  <?php echo csrf_field(); ?>
        ...
        <div class="form-group col-1">
            ...
            <input class="form-control" type="text" name="application_day" value="">
        </div>
...
<div id="table-block">
    ...
    <div class="form-group col-2 my-4">
        ...
        <input class="form-control" type="text" value="" name="subtotal">
    </div>

    
    <div class="form-group col-1 my-4">
        <label class="label">消費税</label>
        <input class="form-control" type="text" value="" name="tax_amount">
    </div>

    <div class="form-group col-2 my-4">
        <label class="label">発注金額合計</label>
        <input class="form-control" type="text" value="" name="total_amount">
    </div>
     ...
     <div class="col-4 my-4">
        ...
        <div class="btn-area">
            <button type="submit" class="btn btn-primary add" style="margin: 100px">申請</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel_web_application/resources/views/posts/show_edit.blade.php ENDPATH**/ ?>