...
<form  method="post" action="<?php echo e(route('post.update',['id=>$posts->id'])); ?>">
  <?php echo csrf_field(); ?>
        
       <div class="form-group col-1">
         <label class="label">申請No<br>（自動表示）</label>
         <input class="form-control" type="text" name="id" value="<?php echo e($posts->id); ?>">
       </div>
        ...
        <div class="form-group col-1">
             ...
             <input class="form-control" type="text" name="" value="<?php echo e($posts->purchasing_url); ?>">
        </div>
...
<div id="table-block">
    ...
    <div class="form-group col-1">
      ...
      <input class="form-control" type="text" name="delivery_hope_day" value="<?php echo e($posts->delivery_hope_day); ?>">
        ...
        <div class="btn-area">
            <button type="submit" class="btn btn-primary add" style="margin: 100px">更新する</button>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel_web_application/resources/views/posts/edit_applicant.blade.php ENDPATH**/ ?>