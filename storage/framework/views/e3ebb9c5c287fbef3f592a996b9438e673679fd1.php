   ...
   <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-fullscreen">
      ...
      <div class="modal-body">
          <form method="get" action="<?php echo e(route('posts.create_applicant')); ?>"  class="form-group col-2 my-4 " >
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel_web_application/resources/views/livewire/search.blade.php ENDPATH**/ ?>