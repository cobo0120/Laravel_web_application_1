...
<div class="text-right">
  <a href="<?php echo e(route('post.create_copy',['id'=>$posts->id])); ?>"><button class="btn btn-success">複写新規</button></a>
</div>
        ...
        <div class="form-group col-1">
            <label class="label">部署名</label>
             <select class="form-control" name="department_name" value="<?php echo e($posts->department_id); ?>">
        ...
        <div class="form-group col-1">
             ...
             <input class="form-control" type="text" name="delivery_day" value="<?php echo e($posts->purchasing_url); ?>">
        </div>
...
<div id="table-block">
    ...
    <form  method="get" action="<?php echo e(route('post.edit_applicant',['id'=>$posts->id])); ?>">
    <?php echo csrf_field(); ?>
        <div class="btn-area">
    ...
    <form  method="post" action="<?php echo e(route('post.destroy',['id'=>$posts->id])); ?>">
      <?php echo csrf_field(); ?>
          <div class="btn-area">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel_web_application/resources/views/posts/show_applicant.blade.php ENDPATH**/ ?>